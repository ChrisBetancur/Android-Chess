...
/**
 * Represents a Rook.
 * A Rook can only move vertically or horizontally.
...
public class Rook extends Piece {
     ...
     * sets the Color and initializes hasMoved to start at false
    ...
    /**
     * EFFECT:
     * moves the rook to the input row/column if it can move there
